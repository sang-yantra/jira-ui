...
function AppDrawer() {
  return (
    <div className="h-screen">
      <div className="flex flex-col justify-between h-full p-3 w-60 bg-gray-900 dark:bg-gray-900 dark:dark:text-gray-100">
        <div className="space-y-3">
          ...
          <div className="flex-1">
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              ...
              <li className="rounded-sm dark:dark:bg-gray-800 dark:dark:text-gray-50 hover:bg-slate-600">
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="flex items-center p-2 space-x-3 rounded-md"
