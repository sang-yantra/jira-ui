...
function AppDrawer() {
  return (
    <div className="h-screen">
      <div className="flex h-full w-60 flex-col justify-between bg-gray-900 p-3 dark:bg-gray-900 dark:dark:text-gray-100">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button className="p-2">
              <svg
                ...
                viewBox="0 0 512 512"
                className="h-5 w-5 fill-current dark:dark:text-gray-100"
              >
          ...
          <div className="flex-1">
            <ul className="space-y-1 pt-2 pb-4 text-sm">
              <li className="rounded-sm hover:bg-slate-600">
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    className="h-5 w-5 fill-current dark:dark:text-gray-400"
                  >
              ...
              <li className="rounded-sm hover:bg-slate-600 dark:dark:bg-gray-800 dark:dark:text-gray-50">
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="flex items-center space-x-3 rounded-md p-2"
